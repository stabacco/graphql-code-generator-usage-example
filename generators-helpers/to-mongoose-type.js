...
function toMongooseType(field) {
  if (field && field !== '') {
    ...
    if (field.directives['column'] && field.directives['column'].type) {
      result = field.directives['column'].type;
      ...
      let tType = 'Mongoose.Schema.Types.ObjectId';
